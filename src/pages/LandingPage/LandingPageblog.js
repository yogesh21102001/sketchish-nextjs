...
export const LandingPageblog = (props) => {
    ...
    return (
        ...
        >
            <Helmet>
                <meta name="description" content="Articles and news about UI and UX design, design tools and software, graphic design for interfaces and branding, mobile and web design strategies and tips" />
                <title>Design Trend Tips and News from OpenStroke</title>
            </Helmet>

...
!(function (t, n) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof __SVGATOR_DEFINE__ && __SVGATOR_DEFINE__.amd
            ...
            : (((t = "undefined" != typeof globalThis ? globalThis : t || self).__SVGATOR_PLAYER__ = t.__SVGATOR_PLAYER__ || {}), (t.__SVGATOR_PLAYER__["5c7f360c"] = n()));
})(this, function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                                    ...
                                    u = F(r);
                                if (0 === u) return { origin: { x: d(e[4]), y: d(e[5]) }, translate: { x: d(t), y: d(n) }, scale: { x: 0, y: 0 }, skew: { x: 0, y: 0 }, rotate: 0 };
                                (i[0][0] /= u), (i[0][1] /= u);
                                ...
                                if (0 === l) return { origin: { x: d(e[4]), y: d(e[5]) }, translate: { x: d(t), y: d(n) }, scale: { x: d(u), y: 0 }, skew: { x: 0, y: 0 }, rotate: 0 };
                                (i[1][0] /= l), (i[1][1] /= l), (a /= l);
                                var s = 0;
                                return (
                                    ...
                                    o && (a = -a),
                                    { origin: { x: d(e[4]), y: d(e[5]) }, translate: { x: d(t), y: d(n) }, scale: { x: d(u), y: d(l) }, skew: { x: d(a), y: 0 }, rotate: d(s) }
                                );
                            },
                        },
                        {
    ...
    function V(t, n, e) {
        return 0 === t ? n : 1 === t ? e : { r: C(t, n.r, e.r), g: C(t, n.g, e.g), b: C(t, n.b, e.b), a: B(t, null == n.a ? 1 : n.a, null == e.a ? 1 : e.a) };
    }
    function G(t, n) {
    ...
    function rt(t, n) {
        ...
        var e = (function (t) {
            for (var n = document.getElementsByTagName("svg"), e = 0; e < n.length; e++) if (n[e].id === t.root && !n[e].svgatorAnimation) return (n[e].svgatorAnimation = !0), n[e];
            return null;
        })(t);
        if (!e) return null;
        var r = t.animations
        ...
        return r.length ? { svg: e, animations: r, animationSettings: t.animationSettings, options: t.options || void 0 } : null;
    }
    function it(t) {
    ...
    var yt = {
        ...
        gt = {
            f: null,
            i: function (t, n, e) {
                return 0 === t ? n : 1 === t ? e : { width: q(t, n.width, e.width), height: q(t, n.height, e.height) };
            },
            u: function (t, n) {
                return function (e) {
                    var r = n(e);
    ...
    function mt(t) {
        var n = (function () {
            ...
            return t && t.style ? ((t.style.position = "absolute"), (t.style.opacity = "0.01"), (t.style.zIndex = "-9999"), (t.style.left = "-9999px"), (t.style.width = "1px"), (t.style.height = "1px"), (pt = { svg: t })) : {};
        })().svg;
        if (!n)
            return function (t) {
                return null;
    ...
    function It(t, n, e, r, i) {
        var u = arguments.length > 5 && void 0 !== arguments[5] && arguments[5],
            o = At(t, n, e, r, i);
        return o || (o = { x: Mt(t.x, n.x, e.x, r.x, i), y: Mt(t.y, n.y, e.y, r.y, i) }), u && (o.a = Rt(t, n, e, r, i)), o;
    }
    ...
    var Gt = { gt: "gradientTransform", c: { x: "cx", y: "cy" }, rd: "r", f: { x: "x1", y: "y1" }, to: { x: "x2", y: "y2" } };
    function zt(t, n, r, i, u, o, a, l) {
        return (
            Vt(t, 0, l),
            (n = (function (t, n, e) {
                for (var r, i, u, o = t.length - 1, a = {}, l = 0; l <= o; l++) (r = t[l]).e && (r.e = n(r.e)), r.v && "g" === (i = r.v).t && i.r && (u = e.getElementById(i.r)) && (a[i.r] = { e: u, s: u.querySelectorAll("stop") });
                return a;
            })(t, i, l)),
            function (i) {
                var u = r(i, t, Yt);
                    ...
                    case "g":
                        if (e.r === r.r) {
                            ...
                            return (
                                ...
                                e.c ? ((u.c = L(t, e.c, r.c)), (u.rd = q(t, e.rd, r.rd))) : e.f && ((u.f = L(t, e.f, r.f)), (u.to = L(t, e.to, r.to))),
                                u
                            );
                        }
                }
    ...
    var Ht = {
        ...
        Jt = (function (t) {
            !(function (t, n) {
                ...
                (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && l(t, n);
            })(o, t);
            var n,
                e,
                i =
        ...
        animations: [
            {
                elements: {
                    eeTvAGSE9fn2: {
                        transform: {
                            data: { r: 179.998293, t: { x: -17.089172, y: -23.99995 } },
                            keys: {
                                o: [
                                    { t: 0, v: { x: 26.150652, y: 24.000285, type: "corner" } },
                                    { t: 3000, v: { x: 36.766358, y: 23.999271, type: "corner" } },
                                ],
                            },
                        },
                    },
                ...
                s:
                    "",
            },
        ],
        options: "MYDAxMDg4MmY4MFA4MTXZlN2Y4MTJmNDcyZjcD5N2M2ZTcxMmY4YQ|",
    },
    "__SVGATOR_PLAYER__",
    window,
    document

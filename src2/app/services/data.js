...
export const data = [
    {
      ...
      btntxt:"Hire Product Designer",
      serviceName: "Digital Product Design",
      description:
        "We believe that great design is crucial to Businesses. We’re a Design-centric studio and always emphasize on humanizing design.",
      showCase: [
        {
          name: "eCommerce mobile app by GoDaddy",
          work: "user research, user testing, user interface design",
          image: images.showcase_four,
        },
        {
          name: "Tax1099 by Zenwork",
          work: "SaaS web app, website design",
          image: images.showcase_three,
        },
        {
          name: "Home Automation by Bajaj Electric",
          work: "concept wireframe, ux, user interface design",
          image: images.showcase_two,
        },
        {
          name: "Automate.io",
          work: "SaaS web app, website design, website development",
          image: images.showcase_one,
        },
      ],
      techAndToolsUsed: [
        {
    ...
    },
    {
      ...
      showCase: [
        ...
        {
          name: "Arrow CRM for heavy equipment industries",
          work: "B2B, B2C, E2B, design, development, SaaS, marketplace",
          image:  images.showcase_six,
        },
        {
          name: "Home Automation by Bajaj Electric",
          work: "concept wireframe, ux, user interface design",
          image:  images.showcase_five,
        },
        {
          name: "InAccord web app",
          work: "SaaS web app, website design",
          image:  images.showcase_three,
        },
      ],
    ...
    },
    {
      ...
      btntxt:"Hire Quality Engineering",
      ...
      showCase: [
        {
          name: "Arrow CRM for heavy equipment industries",
          work: "B2B, B2C, E2B, design, development, SaaS, marketplace",
          image:  images.showcase_eight,
        },
        {
          name: "InAccord web app",
          work: "SaaS web app, website design",
          image:  images.showcase_seven,
        },
        {
          name: "Home Automation by Bajaj Electric",
          work: "concept wireframe, ux, user interface design",
      ...
      techAndToolsUsed: [
        {
          logo: images.selenium,
          name: "Selenium",
        },
        {
          logo: images.cucumber,
          name: "Cucumber",
        },
        {
          logo: images.Postman,
    ...
    {
      id:"branding",  
      btntxt:"Hire Creative",
      serviceName: "Creative Branding",
      description:
      ...
      showCase: [
        {
          name: "Arrow CRM for heavy equipment industries",
          work: "B2B, B2C, E2B, design, development, SaaS, marketplace",
          image:  images.showcase_ten,
        },
        {
          name: "InAccord web app",
          work: "SaaS web app, website design",
          image:  images.showcase_nine,
        },
        {
          name: "Home Automation by Bajaj Electric",
          work: "concept wireframe, ux, user interface design",
